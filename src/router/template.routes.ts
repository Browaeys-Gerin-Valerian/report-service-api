...
import { createTemplateSchema, deleteTemplateSchema, getOneTemplateSchema, updateTemplateSchema, analyzeTemplateSchema } from "@middlewares/zod/schemas/template.schema";
...
router.get("/templates/:id/analyze", validateRequest(analyzeTemplateSchema), templateController.analyze);
