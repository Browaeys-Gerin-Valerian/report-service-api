...
import { createTemplateSchema, deleteTemplateSchema, getAllTemplatesSchema, getOneTemplateSchema, updateTemplateSchema } from "../middlewares/zod/schemas/templates.schema";
