import { BaseStructure, DataCollection, DataImage, DataObject, DataSchema, DataStructureCollection, DataStructureObject, DataStructureSchema } from "@custom_types/entity";
